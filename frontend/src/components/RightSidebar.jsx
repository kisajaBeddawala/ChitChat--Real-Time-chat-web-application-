  ...
  return selectedUser &&(
    <div className={`bg-[#8185B2]/10 text-white w-full relative overflow-y-scroll ${selectedUser ? "max:md:hidden" : ""}`}>
      ...
      <button className='absolute bottom-5 left-1/2 transform -translate-x-1/2
       bg-linear-to-r from-purple-400 to-violet-600 rounded-full text-white border-none px-20 text-sm py-2 cursor-pointer hover:scale-105 transition-all duration-300 ease-in-out'>
        Logout
      </button>
    </div>
  )
